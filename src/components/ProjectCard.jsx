...
const ProjectCard = ({ title, image, gif, description, techStack, githubLink, previewLink }) => {
    return (
        <div className="group bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col overflow-hidden border border-gray-100 dark:border-gray-800">
            ...
            <div className="p-5 flex flex-col grow">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    {techStack && techStack.map((tech, index) => (
                        <span
                            key={index}
                            className="px-2.5 py-1 bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-200 text-[11px] font-semibold rounded-md tracking-wide"
                        >
                            {tech}
                        </span>
                    ))}
                ...
                {(githubLink || previewLink) && (
                    <div className='pt-4 border-t border-gray-100 dark:border-gray-800 flex flex-wrap gap-3 mt-auto'>
